...
- การส่งรูปไปถาม keyword จาก AI ทางเราใช้ algorithm ที่ทำให้ต้นทุนถูกกว่าหลายๆเจ้า แม้คุณจะส่งภาพใหญ่ มาให้โปรแกรมเจนก็ตาม  <br>
  โดยจากการทดลอง คุณเสีย API cost แค่ 0.02 บาทต่อรูป (gpt-4o-mini) ถูกที่สุดในตลาดปัจจุบัน แม้ว่าภาพที่ส่งมาจะใหญ่แค่ไหนก็ตาม  <br>
- สามารถกดปุ่ม save ที่หน้าโปรแกรมได้ เพื่อจะได้ไม่ต้องคอยกรอก api_key ทุกๆครั้งที่ใช้โปรแกรม  <br>
- ทดลองใช้งานได้ 5 รูป และ สำหรับผู้มี usk => 10 รูปแรกของแต่ละ folder **ฟรี** ถ้ารันมากกว่า 50 รูปขึ้นไป  <br>
