...
3. สามารถ ดู prompt จากรูป (BETA) อัตโนมัต และนำมาช่วยในการคิด title/keyword ได้ เพื่อให้ได้คำที่ตรงความต้องการของ user ที่สุด
4. ban คำว่า Vector หรือ Vectors ใน รูป jpg และ jpeg (automatic)
5. สามารถระบุจำนวนตัวอักษรของ title ได้หลากหลายขึ้น
6. ฟังชั่น GenPrompt [PromptMJ!] สามารถเลือกจำนวน prompt ที่ต้องการได้หลากหลายมากขึ้น
7. เพิ่มความแตกต่าง ระหว่าง title กับ description สำหรับ user ที่ต้องนำไปส่ง Dreamstime.
8. ปรับปรุงสำหรับฟังชั่น STOP list.
9. ปรับปรุงโปรแกรมให้รองรับ เวลา AI ส่งคำตอบผิดพลาด สำหรับ Error Message ของ AI ในเวอชั่นใหม่ๆ
10. Template ที่ถูกระบุไว้ใน Title Style จะถูกนำมา Damage และเอามาใส่ไว้ใน Keywords ด้วย
11. ใน กรณี เลือก เจนแบบมี category จะได้ csv ทั้ง 2 แบบ คือแบบปกติที่ไม่มี category และแบบมี category.
