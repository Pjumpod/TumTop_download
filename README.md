...
<ol>
<li>เพิ่ม model ใหม่ จาก Gemini-3.1-pro และ Gemini-3.1-tumtop</li>
<li>เพิ่ม model ใหม่ จาก Claude Sonnet 4.6</li>
<li>เพิ่มฟั่งชั่นให้ สามารถเปลี่ยนชื่อไฟล์ทั้ง Folder ตาม Title และแก้ไข csv file ให้ด้วยแบบอัตโนมัติ</li>
<ul>
<li>สามารถแก้ชื่อไฟล์ ได้ทั้งรอบอดีต ไม่จำเป็นต้องเป็นรอบล่าสุดเท่านั้น แต่ต้องเป็น output folder จาก tumtop 5.2.0 ขึ้นไป</li>
<li>หลังเปลี่ยน ชื่อแล้ว ถ้าเป็นรอบล่าสุดจะไม่สามารถ edit metadata จาก แอพได้ (ตรงช่อง live)</li>
<li>ก่อนเปลี่ยนชื่อ ขอให้ ปิด รูปหรือวีดีโอ หรือ csv ไฟล์ ที่เปิดอยู่ ให้หมด ให้มั่นใจว่าไม่มีโปรแกรมหรือแอพใดๆเปิดไฟล์นั้นๆอยู่</li>
</ul>
<li>ปรับปรุงความไวในการเปิดโปรแกรม</li>
<li>แก้ไขบั๊กใน openai ที่นำเอา title ทั้งประโยคมาเป็น keyword</li>
<li>แก้ algorithm ในการตัดคำ เมื่อเลือกให้ title และ description ไม่เหมือนกัน</li>
</ol>
